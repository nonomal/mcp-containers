...
An MCP server for GitHub. It allows you to interact with GitHub repositories using the Model Context Protocol (MCP).
...
```bash
docker pull ghcr.io/metorial/mcp-container--modelcontextprotocol--servers--github
```
...
ghcr.io/metorial/mcp-container--modelcontextprotocol--servers--github  "cd ./src/github && node ./dist/index.js"
```
